...
const SignUp = () => {
  ...
  return (
    ...
    <div id="signUP" className='text-white h-[100vh]  flex flex-col justify-center items-center bg-red-400 bg-cover' style={{ "backgroundImage": "url('../src/assets/pesa/bg2.jpg')" }}>

      <div className='bg-slate-800 border-slate-400 rounded-md p-8 shadow-lg backdrop-blur-md bg-opacity-60 relative'>
        <img className="border-slate-400 my-3 py-3" width={80} height={80} src="../src/assets/pesa/icon.png" alt="logo image" />
