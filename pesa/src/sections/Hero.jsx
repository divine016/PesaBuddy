...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 item sm:h[100vh] sm:">
        ...
        <h1 className="mt-10 font-palanquin text-4xl max-sm:text-[64px] min-sm:leading-[82] font-bold">
          <span className="xl:bg-white dark:bg-[#171b3f] dark:text-white xl:whitespace-nowrap relative z-10 lg:py-1  leading-normal">Effortless tracking,  powerful <br />insights, with </span>
      ...
      <div className="relative  flex flex-1 items-center justify-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
         ...
         width={610} 
         height={500} 
         className="-z-1 relative object-contain"/>
